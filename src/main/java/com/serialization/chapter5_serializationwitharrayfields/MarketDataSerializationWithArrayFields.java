...
public class MarketDataSerializationWithArrayFields implements Serializable{
	...
	public MarketDataSerializationWithArrayFields() {
		super();
	...
	public MarketDataSerializationWithArrayFields(String securityId, long time, double open, double high, double low,
	...
	public String toString() {
		return "MarketDataSerializationWithArrayFields [securityId=" + securityId + ", time=" + time + ", open=" + open
