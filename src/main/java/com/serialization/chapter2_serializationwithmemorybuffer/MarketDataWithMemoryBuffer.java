...
public class MarketDataWithMemoryBuffer implements Serializable{
	...
	public MarketDataWithMemoryBuffer() {
		super();
		// TODO Auto-generated constructor stub
	}
	public MarketDataWithMemoryBuffer(String securityId, long time, double open, double high, double low, double close,
	...
	public String toString() {
		return "MarketDataWithMemoryBuffer [securityId=" + securityId + ", time=" + time + ", open=" + open + ", high="
